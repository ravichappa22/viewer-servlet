...
public class IOInfoList  implements java.io.Serializable {
    private IOFieldList[] IOFieldListArray;

    public IOInfoList() {
    }

    public IOInfoList(
           IOFieldList[] IOFieldListArray) {
     ...
     */
    public IOFieldList[] getIOFieldListArray() {
        return IOFieldListArray;
    }
     ...
     */
    public void setIOFieldListArray(IOFieldList[] IOFieldListArray) {
        this.IOFieldListArray = IOFieldListArray;
    }

    public IOFieldList getIOFieldListArray(int i) {
        return this.IOFieldListArray[i];
    }

    public void setIOFieldListArray(int i, IOFieldList _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getIOFieldListArray() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getIOFieldListArray(), i);
                if (obj != null &&
