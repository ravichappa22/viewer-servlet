...
public class TableSections  implements java.io.Serializable {
     ...
     * @param section
     */
    public void setSection(S_Info[] section) {
        this.section = section;
    }

    public S_Info getSection(int i) {
        return this.section[i];
    }

    public void setSection(int i, S_Info _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getSection() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSection(), i);
                if (obj != null &&
