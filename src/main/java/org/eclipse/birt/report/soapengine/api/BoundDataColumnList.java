...
public class BoundDataColumnList  implements java.io.Serializable {
    ...
    public BoundDataColumn getBoundDataColumn(int i) {
        return this.boundDataColumn[i];
    }

    public void setBoundDataColumn(int i, BoundDataColumn _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getBoundDataColumn() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getBoundDataColumn(), i);
                if (obj != null &&
