...
public class Export  implements java.io.Serializable {
    private Vector availableColumns;
    private Vector selectedColumn;
    ...
    public Export(
           Vector availableColumns,
           Vector selectedColumn,
     ...
     */
    public void setAvailableColumns(Vector availableColumns) {
        this.availableColumns = availableColumns;
    }
     ...
     * @param criteria
     */
    public void setCriteria(ExportCriteria[] criteria) {
        this.criteria = criteria;
    }

    public ExportCriteria getCriteria(int i) {
        return this.criteria[i];
    }

    public void setCriteria(int i, ExportCriteria _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getCriteria() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getCriteria(), i);
                if (obj != null &&
