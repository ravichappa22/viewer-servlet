...
public class NumberCategoryChoice  implements java.io.Serializable {
    ...
    public NumberCategoryChoice(
           ...
           Vector decimalPlaces,
           Vector symbol,
           Vector symbolPosition,
           Vector negativeNumberFormat,
     ...
     * @param decimalPlaces
     */
    public void setDecimalPlaces(Vector decimalPlaces) {
        this.decimalPlaces = decimalPlaces;
    }
     ...
     * @param symbol
     */
    public void setSymbol(Vector symbol) {
        this.symbol = symbol;
    }
     ...
     */
    public void setSymbolPosition(Vector symbolPosition) {
        this.symbolPosition = symbolPosition;
    }
     ...
     */
    public void setNegativeNumberFormat(Vector negativeNumberFormat) {
        this.negativeNumberFormat = negativeNumberFormat;
    }
