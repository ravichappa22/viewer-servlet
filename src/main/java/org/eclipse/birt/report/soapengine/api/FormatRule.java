...
public class FormatRule  implements java.io.Serializable {
    private FormatRuleCondition condition;
    private FormatRuleEffect effect;
     ...
     * @return condition
     */
    public FormatRuleCondition getCondition() {
        return condition;
    }
     ...
     * @param condition
     */
    public void setCondition(FormatRuleCondition condition) {
        this.condition = condition;
    }
     ...
     * @return effect
     */
    public FormatRuleEffect getEffect() {
        return effect;
    }
     ...
     * @param effect
     */
    public void setEffect(FormatRuleEffect effect) {
        this.effect = effect;
    }
