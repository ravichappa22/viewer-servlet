...
public class SelectionList  implements java.io.Serializable {
    private String name;
    private SelectItemChoice[] selections;
     ...
     * @return selections
     */
    public SelectItemChoice[] getSelections() {
        return selections;
    }
     ...
     * @param selections
     */
    public void setSelections(SelectItemChoice[] selections) {
        this.selections = selections;
    }

    public SelectItemChoice getSelections(int i) {
        return this.selections[i];
    }

    public void setSelections(int i, SelectItemChoice _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getSelections() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSelections(), i);
                if (obj != null &&
