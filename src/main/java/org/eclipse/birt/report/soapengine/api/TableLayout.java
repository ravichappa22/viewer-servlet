...
public class TableLayout  implements java.io.Serializable {
     ...
     */
    public void setCH_Row(TableRowInfo CH_Row) {
        this.CH_Row = CH_Row;
    }
     ...
     */
    public void setTC_Row(TableRowInfo TC_Row) {
        this.TC_Row = TC_Row;
    }
     ...
     * @param sections
     */
    public void setSections(TableSections sections) {
        this.sections = sections;
    }
     ...
     * @param groups
     */
    public void setGroups(TableGroups groups) {
        this.groups = groups;
    }
