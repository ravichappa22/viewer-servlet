...
public class ViewingSession implements IViewingSession, Serializable
{
	...
	/**
	 * @see IViewingSession#getLastAccess()
	 */
	 ...
	 * @see IViewingSession#getCachedReportDocument(String,
	 *      String)
	 */
	 ...
	 * @see IViewingSession#getImageTempFolder()
	 */
	...
	/**
	 * @throws ViewerException 
	 * @see IViewingSession#invalidate()
	 */
