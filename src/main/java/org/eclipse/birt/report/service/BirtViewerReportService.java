...
public class BirtViewerReportService implements IViewerReportService
{
	...
	/**
	 * @see IViewerReportService#runReport(IViewerReportDesignHandle,
	 *      String, InputOptions,
	 *      Map)
	 */
	...
	/**
	 * @see IViewerReportService#getPage(String,
	 *      String, InputOptions,
	 *      List)
	 */
	...
	/**
	 * @see IViewerReportService#getPageByBookmark(String,
	 *      String, InputOptions,
	 *      List)
	 */
	...
	/**
	 * @see IViewerReportService#getPageByObjectId(String,
	 *      String, InputOptions,
	 *      List)
	 */
	...
	/**
	 * @see IViewerReportService#getReportlet(String,
	 *      String, InputOptions,
	 *      List)
	 */
	...
	/**
	 * @see IViewerReportService#renderReportlet(String,
	 *      String, InputOptions,
	 *      List, OutputStream)
	 */
	...
	/**
	 * @see IViewerReportService#renderReport(String,
	 *      int, String,
	 *      InputOptions,
	 *      OutputStream)
	 */
	...
	/**
	 * @see IViewerReportService#extractData(String,
	 *      InputOptions, OutputStream)
	 */
	...
	/**
	 * @see IViewerReportService#extractResultSet(String,
	...
	/**
	 * @see IViewerReportService#getResultSetsMetadata(String,
	 *      InputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#getImage(String,
	 *      String, OutputStream,
	 *      InputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#getTOC(String,
	 *      String, InputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#findTocByName(String,
	 *      String, InputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#getPageCount(String,
	 *      InputOptions,
	 *      OutputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#getParameterDefinitions(IViewerReportDesignHandle,
	...
	/**
	 * @see IViewerReportService#getSelectionListForCascadingGroup(IViewerReportDesignHandle,
	 *      String, Object[],
	 *      InputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#getParameterSelectionList(IViewerReportDesignHandle,
	 *      InputOptions, String)
	 */
	...
	/**
	 * @see IViewerReportService#getPageNumberByBookmark(String,
	 *      String, InputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#getPageNumberByObjectId(String,
	 *      String, InputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#runAndRenderReport(IViewerReportDesignHandle,
	 *      String, InputOptions,
	 *      Map, OutputStream, List)
	 */
	...
	/**
	 * @see IViewerReportService#getParameterDefaultValue(IViewerReportDesignHandle,
	 *      String, InputOptions)
	 */
	...
	/**
	 * @see IViewerReportService#setContext(Object,
	 *      InputOptions)
	 */
